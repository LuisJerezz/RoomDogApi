...
import com.santi.pmdm.virgen.dogapicleanarchitecture.data.datasource.database.dao.DogDao_DatabaseDogs_Impl;
...
public final class DatabaseDogs_Impl extends DatabaseDogs {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(DogDao.class, DogDao_DatabaseDogs_Impl.getRequiredConverters());
  ...
  public DogDao dogDao() {
    if (_dogDao != null) {
      ...
      synchronized(this) {
        if(_dogDao == null) {
          _dogDao = new DogDao_DatabaseDogs_Impl(this);
        }
        return _dogDao;
      }
    }
